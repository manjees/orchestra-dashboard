...
class AgentDetailScreenTest {
    ...
    @Test
    fun `should switch to pipelines tab on click`() =
        runComposeUiTest {
            setContent {
                DashboardTheme {
                    AgentDetailScreen(
    ...
    @Test
    fun `should switch to events tab on click`() =
        runComposeUiTest {
            setContent {
                DashboardTheme {
                    AgentDetailScreen(
    ...
    @Test
    fun `should invoke onBack when back button is clicked`() =
        runComposeUiTest {
    ...
    @Test
    fun `should display agent type in top bar`() =
        runComposeUiTest {
            setContent {
                DashboardTheme {
                    AgentDetailScreen(
